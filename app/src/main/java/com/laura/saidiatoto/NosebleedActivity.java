...
public class NosebleedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.ninst_title);
        cc = findViewById(R.id.nurncommonCauses);
        sandm = findViewById(R.id.nurnsandm);
        moreinfo = findViewById(R.id.nmoreInfo);
        steps = findViewById(R.id.nurnsteps);
        animationspace = findViewById(R.id.nurninstructionImage);

        Query query = reference.child("-MiQdlU0OwtoJ0kTPPVC");
