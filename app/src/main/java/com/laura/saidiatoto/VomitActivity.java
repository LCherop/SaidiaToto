...
public class VomitActivity extends AppCompatActivity {
...
//private String k ="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.vinst_title);
        cc = findViewById(R.id.vurncommonCauses);
        sandm = findViewById(R.id.vurnsandm);
        moreinfo = findViewById(R.id.vmoreInfo);
        steps = findViewById(R.id.vurnsteps);
        animationspace = findViewById(R.id.vurninstructionImage);

        Query query = reference.child("-MiQh0vlwvPtczJ996uI");
