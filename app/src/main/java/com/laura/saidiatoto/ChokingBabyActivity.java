...
public class ChokingBabyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choking_baby);
        ...
        title = findViewById(R.id.cbinst_title);
        cc = findViewById(R.id.cburncommonCauses);
        sandm = findViewById(R.id.cburnsandm);
        moreinfo = findViewById(R.id.cbmoreInfo);
        steps = findViewById(R.id.cburnsteps);
        animationspace = findViewById(R.id.cburninstructionImage);

        Query query = reference.child("-MiQlrDuWYi6f7qvrlEi");
