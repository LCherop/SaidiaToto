...
public class CroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_croup);
        ...
        title = findViewById(R.id.cinst_title);
        cc = findViewById(R.id.curncommonCauses);
        sandm = findViewById(R.id.curnsandm);
        moreinfo = findViewById(R.id.cmoreInfo);
        steps = findViewById(R.id.curnsteps);
        animationspace = findViewById(R.id.curninstructionImage);


        Query query = reference.child("-MiQjwSn0imUiubZZCwY");
