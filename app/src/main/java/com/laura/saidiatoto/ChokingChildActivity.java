...
public class ChokingChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choking_child);
        ...
        title = findViewById(R.id.ccinst_title);
        cc = findViewById(R.id.ccurncommonCauses);
        sandm = findViewById(R.id.ccurnsandm);
        moreinfo = findViewById(R.id.ccmoreInfo);
        steps = findViewById(R.id.ccurnsteps);
        animationspace = findViewById(R.id.ccurninstructionImage);

        Query query = reference.child("-MiQmj91Tpm1JsT6Tty3");
