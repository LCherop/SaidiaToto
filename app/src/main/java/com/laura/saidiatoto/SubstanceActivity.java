...
public class SubstanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.sinst_title);
        cc = findViewById(R.id.surncommonCauses);
        sandm = findViewById(R.id.surnsandm);
        moreinfo = findViewById(R.id.smoreInfo);
        steps = findViewById(R.id.surnsteps);
        //animationspace = findViewById(R.id.surninstructionImage);

        Query query = reference.child("-MiQfB1oqx7xq4_Ex9QU");
